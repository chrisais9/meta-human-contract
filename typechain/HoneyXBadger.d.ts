...
interface HoneyXBadgerInterface extends ethers.utils.Interface {
  functions: {
...
export type NonFungibleTokenRecoveryEvent = TypedEvent<
  [string, BigNumber] & { token: string; tokenId: BigNumber }
>;
...
export class HoneyXBadger extends BaseContract {
  ...
  interface: HoneyXBadgerInterface;
